...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 text-right">
              <div class="card-header py-3">
                <a href="new_city.vw.php" class="btn btn-sm btn-success shadow-sm">
                  <i class="fas fa-address-book fa-sm text-white-50"></i> Add City
                </a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-bordered" id="tbl_data_citites" width="100%" cellspacing="0">
                    <thead>
                      <tr class="text-center">
                        <th>Name of City</th>
                        <th>Name of Country</th>
                        <th>Format of Zip Code</th>
                        <th>Date</th>
                      </tr>
                    </thead>
                    <tbody>
  ...
  <script src="vendor/datatables/dataTables.bootstrap4.min.js"></script>
   ...
   <!--  -->
   <script src="js/index_city.js"></script>
