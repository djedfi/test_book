...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800">New City</h1>
          <p class="mb-4">Fill up the next form to create a new City.</p>
          <br>
          <div class="card shadow mb-4">
              <div class="card-body">
                <form class="needs-validation" id="id_form_city" novalidate>
                    <input type="hidden" name='opt' id='opt' value='3'>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="id_sel_country">Choose Country</label>
                            <select class="custom-select" name="id_sel_country" id="id_sel_country" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="id_txt_city">Name of City</label>
                            <input type="text" class="form-control text-uppercase" name="id_txt_city" id="id_txt_city" pattern="[a-zA-Z\s]+" maxlength="150"  required>
                            <div class="valid-feedback">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="id_txt_fmt_zip">Format of Zip Code</label>
                            <input type="text" class="form-control text-uppercase"  pattern="[Aa0]+" name="id_txt_fmt_zip" id="id_txt_fmt_zip" maxlength="10" required>
                            <small id="id_help_format_zip_newcity" class="form-text text-muted">
                              Enter "A" is letter or "0" is number, without space.
                            </small>
                            <div class="valid-feedback">
                            ...
                            <div class="invalid-feedback">
                                ...
                                - Do not enter space.<br>
                                - The format doesn't match. For example, If the zip is "M1K2N6", enter "A0A0A0".
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; EdFi 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="js/form_new_city.js"></script>
</body>
